...
Ui::Ui(Controller& controller, UserController& user_controller, Validators& validator) : controller{ controller }, user_controller{ user_controller }, validator{validator}
{

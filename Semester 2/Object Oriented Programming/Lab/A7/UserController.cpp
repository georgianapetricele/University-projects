...
{
	//for (int index = 0; index < this->tutorials_by_presenter.size(); index++)

	/*
	for (auto iterator = this->tutorials_by_presenter.begin(); iterator < this->tutorials_by_presenter.end(); iterator++)
	{
		int index = iterator - this->tutorials_by_presenter.begin();
		this->tutorials_by_presenter.erase(tutorials_by_presenter.begin() + index);
	}
	*/

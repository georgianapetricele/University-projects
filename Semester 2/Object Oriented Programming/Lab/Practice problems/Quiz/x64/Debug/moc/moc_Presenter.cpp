...
static constexpr auto qt_meta_stringdata_CLASSPresenterENDCLASS = QtMocHelpers::stringData(
    "Presenter"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSPresenterENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSPresenterENDCLASS_t qt_meta_stringdata_CLASSPresenterENDCLASS = {
    {

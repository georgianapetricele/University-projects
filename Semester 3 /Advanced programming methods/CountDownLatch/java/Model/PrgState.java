...
public class PrgState{
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, MyIDictionary<StringValue, BufferedReader> fileTable, MyIHeap heap,MyILatchTable latchTable,IStmt prg){
        exeStack=stk;
        symTable=symtbl;
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> ot, MyIDictionary<StringValue, BufferedReader> fileTable, MyIHeap heap,MyILatchTable latchTable){
        exeStack=stk;
        symTable=symtbl;
        this.fileTable=fileTable;
        this.heapTable=heap;

...
public class CondAssignStmt implements IStmt{
    ...
    public PrgState execute(PrgState state){
        ...
        // we create a new if statement which has as condition exp1 and
        // assigns to var -> exp2 if exp1 is true,
        // assigns to var -> exp3 otherwise
    ...
    public MyIDictionary<String, Type> typeCheck(MyIDictionary<String, Type> typeEnv) throws MyException {
        // we evaluate the variable var and the expressions exp1, exp2, exp3

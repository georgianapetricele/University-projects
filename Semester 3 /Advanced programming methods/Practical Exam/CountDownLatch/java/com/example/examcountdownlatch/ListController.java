package com.example.examcountdownlatch;
...
public class ListController implements Initializable {
    ...
    public void onRunButton(ActionEvent event) {
        ...
        try {
            ...
            PrgState prg = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap(), new MyLatchTable(),currentProgram);
                        ...
                        new CompStmt(new VarDeclStmt("v", new IntType()),
                                new CompStmt(new NewHeapStmt("a", new ValueExp(new IntValue(0))),
                                        new CompStmt(new NewHeapStmt("b", new ValueExp(new IntValue(0))),
                                                new CompStmt(new writeHStmt("a", new ValueExp(new IntValue(1))),
                                                        new CompStmt(new writeHStmt("b", new ValueExp(new IntValue(2))),
                                                                new CompStmt(new CondAssignStmt("v", new RelationalExp("<", new readHExp(new VarExp("a")), new readHExp(new VarExp("b"))), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                        new CompStmt(new PrintStmt(new VarExp("v")),
                                                                                new CompStmt(new CondAssignStmt("v", new RelationalExp(">", new ArithExp('-', new readHExp(new VarExp("b")), new ValueExp(new IntValue(2))), new readHExp(new VarExp("a"))), new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                                        new PrintStmt(new VarExp("v"))
                                                                                )
                                                                        )
                                                                )
                                                                                        ...
                                                                                        new CompStmt(
                                                                                                ...
                                                                                                new CompStmt(
                                                                                                        ...
                                                                                                        new CompStmt(
                                                                                                                ...
                                                                                                                new ForkStmt(
                                                                                                                        new CompStmt(
                                                                                                                                new writeHStmt("v2", new ArithExp('*', new readHExp(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                                                                                                                new CompStmt(
                                                                                                                                        ...
                                                                                                                                        new CompStmt(
                                                                                                                                                ...
                                                                                                                                                new ForkStmt(
                                                                                                                                                        new CompStmt(
                                                                                                                                                                new writeHStmt("v3", new ArithExp('*', new readHExp(new VarExp("v3")), new ValueExp(new IntValue(10)))),
                                                                                                                                                                new CompStmt(

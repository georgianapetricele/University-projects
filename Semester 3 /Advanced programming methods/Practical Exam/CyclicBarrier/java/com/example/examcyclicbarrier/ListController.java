package com.example.examcyclicbarrier;
...
public class ListController implements Initializable {
    ...
    public void onRunButton(ActionEvent event) {
        ...
        try {
            ...
            PrgState prg = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap(), new MyBarrierTable(),currentProgram);

...
public class ProgramController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        lockValueColumn.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().getKey().toString()));
    ...
    private void populateLockTableView() {
        ...
        MyILock lockTable = Objects.requireNonNull(programState).getLockTable();

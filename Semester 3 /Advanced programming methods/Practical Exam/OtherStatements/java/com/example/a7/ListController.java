...
public class ListController implements Initializable {
    ...
    public void onRunButton(ActionEvent event) {
        ...
        try {
            ...
            PrgState prg = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), new MyDictionary<>(), new MyHeap(), currentProgram);
            IRepository repo = new Repository(prg, "D:\\IdeaProjects\\A7\\src\\main\\java\\log" + id +".txt");
    ...
    private ObservableList<IStmt> getProgramsListView(){
        ...
        //Switch
        IStmt ex17 = new CompStmt(new VarDeclStmt("a", new IntType()),
                new CompStmt(new VarDeclStmt("b", new IntType()),
                        new CompStmt(new VarDeclStmt("c", new IntType()),

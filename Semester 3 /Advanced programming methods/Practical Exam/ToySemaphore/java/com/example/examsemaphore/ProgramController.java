package com.example.examsemaphore;
...
public class ProgramController implements Initializable {
    ...
    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> indexSemaphoreColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, Integer> valueSemaphoreColumn;

    @FXML
    private TableColumn<Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>>, List<Integer>> listSemaphoreColumn;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        valueSemaphoreColumn.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().getValue().getFirst() - p.getValue().getValue().getThird()).asObject());
        listSemaphoreColumn.setCellValueFactory(p -> new SimpleObjectProperty<>(p.getValue().getValue().getSecond()));
    ...
    private void populateSemaphoreTableView() {
        ...
        for (Map.Entry<Integer, Tuple<Integer, List<Integer>, Integer>> entry: semaphoreTable.getSemaphoreTable().entrySet()) {

...
public class Parser {
    ...
    // remove the last element from the working stack and add it to the input stack
    ...
    // if not, remove the non-terminal from the working stack
    // else error
    ...
    public void run() throws IOException {
        while (!state.equals("f") && !state.equals("e")) {
            ...
            if (state.equals("q")) {
                if (input.isEmpty() && index == sequence.size()) success();
                else
